<?php
    ...
    class UnzipFile
    {
        /*
            ...
            Version 1.0
        */
        public static $datasec = array(); // array to store compressed data
        public static $files = array(); // array of uncompressed files
        public static $dirs = array(); // array of directories that have been created already
        public static $ctrl_dir = array(); // central directory
        public static $eof_ctrl_dir = "\x50\x4b\x05\x06\x00\x00\x00\x00"; //end of Central directory record
        public static $old_offset = 0;
